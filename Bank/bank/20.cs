...
namespace bank
{
    public partial class _20 : Form
    {
        ...
        {  
            try
            {
                if (int.Parse(textBox1.Text) >= 2000 && int.Parse(textBox2.Text) <= 240)
                {
                    label6.Text = Convert.ToString((int.Parse(textBox1.Text) * int.Parse(textBox2.Text) * 0.10) + int.Parse(textBox1.Text));
                }
                else
                {
                    ...
                    if (int.Parse(textBox2.Text) > 240)
                    {
