    ...
    public partial class study : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                s.Open();
                SqlCommand cm = new SqlCommand("insert into loan1(name,account,loan,months,deposit1,amount,interest) values('" + n + "','" + y + "','" + "study" + "','" + long.Parse(textBox2.Text) + "','" + textBox1.Text + "','" + label7.Text + "','" + "2 %" + "')", s);
                cm.ExecuteNonQuery();
                s.Close();
