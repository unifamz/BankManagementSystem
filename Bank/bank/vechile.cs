...
namespace bank
{
    public partial class vechile : Form
    {
        public vechile()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                s.Open();
                SqlCommand cm = new SqlCommand("insert into loan1(name,account,loan,months,deposit1,amount,interest) values('" + n + "','" + y + "','" + "vechile" + "','" + long.Parse(textBox2.Text) + "','" + textBox1.Text + "','" + label7.Text + "','" + "10 %" + "')", s);
                cm.ExecuteNonQuery();
                s.Close();
